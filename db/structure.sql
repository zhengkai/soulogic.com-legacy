...
CREATE TABLE `blog` (
  ...
  `original_tag` enum('N','Y') NOT NULL DEFAULT 'Y',
  `publish_tag` enum('N','Y') NOT NULL DEFAULT 'N',
  `rss_tag` enum('N','Y') NOT NULL DEFAULT 'Y',
  `delete_tag` enum('N','Y') NOT NULL DEFAULT 'N',
...
CREATE TABLE `config` (
  ...
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Config';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `guestbook` (
  ...
  `content` text,
  `date_a` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `del_tag` enum('N','Y') NOT NULL DEFAULT 'N',
  `ip` varchar(50) CHARACTER SET ascii DEFAULT NULL,
...
CREATE TABLE `icon_track` (
  ...
  `ip` char(30) CHARACTER SET ascii NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=0;
/*!40101 SET character_set_client = @saved_cs_client */;
